...
class Products {
    ...
    static generateCards(obj) {
        ...
        <div class="card cardAccesories">
            <img src="${obj.thumbnail}" class="card-img-top imgAccesories" alt="...">
            <div class="card-body">
              ...
              <button data-prodid="${obj.id}" data-title="${obj.title}" data-name="${obj.brand}" data-desc="${obj.description}" data-img="${obj.thumbnail}"  class="btn btn-primary getProductDetails ">Details</button>
              <button data-id="${obj.id}" data-title="${obj.title}" data-name="${obj.brand}" data-price="${obj.price}" data-img="${obj.thumbnail}" class="button button4 addToCart">
